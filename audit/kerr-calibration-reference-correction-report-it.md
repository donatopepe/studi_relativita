# Audit correzione posizione riferimento di calibrazione Kerr
...
Controlli corretti `8/8`; batteria scenari `54/54`.
...
La polarità precedente era errata: prodotto positivo consente collisione. Solo un riferimento dentro l'intervallo produce ostruzione di segno. Claim storico superato, non evidenza.
