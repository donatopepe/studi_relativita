# Audit miscela latente di jitter per finestra Kerr
...
Controlli `8/8`; batteria scenari `126/126`.
...
Risultato esatto dalla legge della covarianza totale. La correzione positiva di Jensen sui quarti momenti mostra che il surrogate gaussiano con kernel medio sovrastima l'erosione e cambia il gate di un count, ma entrambi lasciano `N=64` unsafe. La legge incondizionata è una miscela non gaussiana. Nessuna legge di jitter/modello di rumore misurato, significatività, potenza, evidenza o detection.
