# Kerr correlated-noise mismatch audit
...
Controls `8/8`; scenario battery `70/70`.
...
Shared full correlated noise cancels exactly. Operator distance uses full branch matrices. Aggregate mismatch below 0.8 threshold leaves positive separation; exact full threshold collides. No measured mismatch bound or evidence.
