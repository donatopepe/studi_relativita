# Kerr rho-critical latent-lag-law phase audit
...
Controls `8/8`; scenario battery `150/150`.
...
Exact bounded bisection phase map. Below window count 87 passes every lag law; within window finite kappa matters; above window uniform already fails. Window is toy assumption boundary, not confidence/stationarity evidence or measured tolerance. No evidence or detection.
