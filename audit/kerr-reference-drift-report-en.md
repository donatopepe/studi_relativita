# Kerr bounded reference-drift robustness audit
...
Controls `8/8`; scenario battery `62/62`.
...
Analytic open-interval radius is exact. Conservative 0.8 box remains obstructed. Endpoint loses rank/obstruction; outside reference collides exactly. No measured stability or evidence.
