# Kerr bounded pairing-lag audit
...
Controls `8/8`; scenario battery `110/110`.
...
Exact centered cross-time trace calculation. Timing lag monotonically erodes already small common-noise sampling gain; one-window lag restores count 88. `N=64` fails all fixed fractions. No measured lag/noise model, significance, power, evidence or detection.
