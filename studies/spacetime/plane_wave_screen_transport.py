...
def build_artifact(n=5000):
    return {
        ...
        "raw_objects": ["K", "omega", "Q", "W_raw", "W_transport", "local_invariant_averages", "P_raw", "P_naive_conjugated_profile"],
        "phase_map_disposition": "P_naive_conjugated_profile integrates Q^T K Q in the inertial-form Jacobi equation; it is not the rotating-coordinate phase map because connection terms are absent. See plane-wave-covariant-screen-phase-map-v1.",
