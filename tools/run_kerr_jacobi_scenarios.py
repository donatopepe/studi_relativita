...
RHOPHASE_MODULE=ROOT/'studies/spacetime/kerr_rho_critical_lag_law_phase.py'
RHOPHASE_SPEC=importlib.util.spec_from_file_location('kerr_rho_phase_scenario_engine',RHOPHASE_MODULE);rhophase=importlib.util.module_from_spec(RHOPHASE_SPEC);RHOPHASE_SPEC.loader.exec_module(rhophase)
COUNTPHASE_MODULE=ROOT/'studies/spacetime/kerr_count_dependent_rho_phase.py'
COUNTPHASE_SPEC=importlib.util.spec_from_file_location('kerr_count_phase_scenario_engine',COUNTPHASE_MODULE);countphase=importlib.util.module_from_spec(COUNTPHASE_SPEC);COUNTPHASE_SPEC.loader.exec_module(countphase)
SCALEMIX_MODULE=ROOT/'studies/spacetime/kerr_window_scale_mixture.py'
SCALEMIX_SPEC=importlib.util.spec_from_file_location('kerr_scale_mixture_scenario_engine',SCALEMIX_MODULE);scalemix=importlib.util.module_from_spec(SCALEMIX_SPEC);SCALEMIX_SPEC.loader.exec_module(scalemix)
