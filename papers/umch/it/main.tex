...
L'oggetto primario è una sezione $\mathcal R_{\rm op}[\Omega,\ell,u_{\rm phys},\mathcal P;g]$ di un fibrato di risposte channel-native: endomorfismi tidal/magnetic, mappe di olonomia, matrici di residui clock, mappe di Jacobi null e campi di congruenza. Il registro
...
\section{Candidato di riformulazione compatta cinque-dimensionale non ratificato}\label{sec:u-kk-candidate}
UMCH-U-0016 registra l'ipotesi higher-dimensional non ratificata. UMCH-U-0017 registra la derivazione bounded di progetto e UMCH-U-0018 il suo fallimento di identificabilità della scala. Una specifica ratificata per engineering testa se la gravità quattro-dimensionale osservata possa essere proiezione o settore efficace di geometria linearizzata $\mathbb{R}^{1,3}\times S^1$. Profili sorgente--probe localizzati preservano la forma della torre KK, mentre una sorgente o probe uniforme proietta via i modi non nulli. Sorgenti puntiforme, sfera e gaussiana e finestre finite radiali/orientate mostrano dipendenza dalla preparazione. La dilatazione congiunta lascia invarianti le matrici mareali adimensionali. Il risultato bounded è quindi \verb|MODEL_LEVEL_DIMENSIONLESS_KK_SHAPE_DERIVED_NOT_EVIDENCE|, con \verb|L_identified=false|, \verb|ell0_identified=false|, \verb|L_equals_ell0=NOT_DERIVED|, \verb|extra_dimension_detected=false| e \verb|structural_dead_end=NOT_DECLARED|.

La proposta resta \verb|HIGHER_DIMENSIONAL_GRAVITY_CORE=REFORMULATION_CANDIDATE_UNRATIFIED|, \verb|MODEL=LINEARIZED_5D_COMPACT_KK_TOY_CONTROL| e \verb|UMCH=UNPROVEN_SECONDARY_CANDIDATE|. Il precedente oggetto operatoriale resta congelato come \verb|RATIFIED_PRIMARY_RESEARCH_OBJECT|; la storia worldline resta \verb|HISTORICAL_WORLDLINE_FORMULATION| e \verb|SUPERSEDED_AS_CORE|. Risposte raw, proiezioni scalari e $F_0$ sono preservate. \verb|DO NOT MERGE WITHOUT HUMAN SCIENTIFIC RATIFICATION| e \verb|NO_POSITIVE_DETECTION_CLAIM|.
