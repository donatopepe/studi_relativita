...
Sia $(\mathcal M,g_{\rm real})$ lo spaziotempo realizzato, non globalmente isometrico a Minkowski. Introduciamo $\ell_0>0$ e consideriamo regioni causali $\Omega$ con scala $\ell\geq\ell_0$. UMCH-U-0004: il core \verb|UNPROVEN| propone, per un protocollo preregistrato e frame risolto, una risposta dimensionless che soddisfi una soglia selezionata prima dei dati. Nessun claim è formulato sotto $\ell_0$.
...
\section{Vettore operativo grezzo}\label{sec:u-response}
Conserviamo
\begin{equation}\label{eq:u-vector}\mathbf R=(R_{\rm tidal},R_{\rm mag},R_{\rm hol},R_{\rm clock},R_{\rm null},R_{\rm cong}).\end{equation}
Le parti elettrica e magnetica di Weyl seguono la decomposizione covariante standard \cite{Bonnor1995,MaartensBassett1998}. UMCH-U-0006: il vettore grezzo resta pubblico per evitare che una norma o un canale nascondano un controesempio.
...
Norma, canale, regioni, finestre, sottrazioni e incertezze non possono cambiare dopo i dati.
...
e $\ell_{\rm peak}=(p/q)\ell_0$. UMCH-U-0012: è \verb|MATHEMATICAL_IDENTIFIABILITY_CANDIDATE_ONLY|; se $q$ è libero, la degenerazione ritorna.
...
Una regione ammissibile, frame risolto e risposta compatibile con zero sotto incertezze preregistrate può contraddire una soglia positiva nello scope. Una conferma richiederebbe protocollo/norma/famiglia fissi, identificabilità, confronto nullo, nuisance bounds e replica indipendente. UMCH-U-0014: nessun requisito è sostituito da model fit favorevole.
...
Mancano un meccanismo nonlocale indipendente, derivazione di $q$, calibrazione di ampiezza, dati preregistrati e replica. Topologia, caustiche, orizzonti e double counting richiedono ulteriore lavoro. Il passo successivo non è scegliere un kernel conveniente, ma derivare o escludere classi covarianti da teoria indipendente.
