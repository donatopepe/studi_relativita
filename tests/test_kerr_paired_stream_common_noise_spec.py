...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr paired-stream common-noise cancellation MVP',t);self.assertIn('1. [ ] Ratify paired-stream common-noise specification. **ACTIVE**',t)
