...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr latent window-jitter mixture MVP: tasks 1–5 completed',t);self.assertIn('scientific `8/8`, scenarios `126/126`, suite `1293/1293`',t)
