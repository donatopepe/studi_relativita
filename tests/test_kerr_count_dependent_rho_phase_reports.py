...
class Reports(unittest.TestCase):
 ...
 def test_history_and_todo(self):
  ...
  self.assertIn('Kerr count-dependent rho phase MVP: tasks 1–5 completed',TODO.read_text());self.assertIn('scientific `8/8`, scenarios `158/158`, suite `1345/1345`',TODO.read_text());self.assertIn('Full suite: `1345/1345`.',TODO.read_text())
