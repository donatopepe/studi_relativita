...
class Reports(unittest.TestCase):
 ...
 def test_history_todo(self):
  ...
  self.assertIn('4. [x] Generate stable artifacts and bilingual scientific record.',TODO.read_text());self.assertIn('5. [ ] Closure and publication. **ACTIVE — local gates green; push/CI pending**',TODO.read_text());self.assertIn('Full suite: `1189/1189`.',TODO.read_text())
