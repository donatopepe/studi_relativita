...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr bounded pairing-lag erosion MVP: tasks 1–5 completed',t);self.assertIn('scientific `8/8`, scenarios `110/110`, suite `1267/1267`',t)
