...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr bounded pairing-jitter erosion MVP',t);self.assertIn('1. [ ] Ratify bounded pairing-jitter specification. **ACTIVE**',t)
