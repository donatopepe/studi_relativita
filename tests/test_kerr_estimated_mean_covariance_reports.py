...
class Reports(unittest.TestCase):
 ...
 def test_history_todo(self):
  ...
  todo=TODO.read_text();self.assertIn('Previous milestone closure evidence',todo);self.assertIn('Full suite: `1228/1228`.',todo);self.assertIn('GitHub Actions run `34652593522` tests/LaTeX passed.',todo)
