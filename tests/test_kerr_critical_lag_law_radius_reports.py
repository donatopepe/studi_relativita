...
class Reports(unittest.TestCase):
 ...
 def test_history_and_todo(self):
  ...
  self.assertIn('Kerr critical lag-law radius MVP: tasks 1–5 completed',TODO.read_text());self.assertIn('scientific `8/8`, scenarios `142/142`, suite `1319/1319`',TODO.read_text());self.assertIn('Full suite: `1319/1319`.',TODO.read_text())
