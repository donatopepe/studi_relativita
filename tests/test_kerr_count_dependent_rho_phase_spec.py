...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr count-dependent rho phase MVP: tasks 1–5 completed',t);self.assertIn('scientific `8/8`, scenarios `158/158`, suite `1345/1345`',t)
