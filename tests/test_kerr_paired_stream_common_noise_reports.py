...
class Reports(unittest.TestCase):
 ...
 def test_history_and_todo(self):
  ...
  self.assertIn('Kerr paired-stream common-noise cancellation MVP: tasks 1–5 completed',TODO.read_text());self.assertIn('scientific `8/8`, scenarios `102/102`, suite `1254/1254`',TODO.read_text());self.assertIn('Full suite: `1254/1254`.',TODO.read_text())
