...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr correlated-noise mismatch threshold MVP',t);self.assertIn('1. [ ] Ratify correlated-noise mismatch specification. **ACTIVE**',t)
