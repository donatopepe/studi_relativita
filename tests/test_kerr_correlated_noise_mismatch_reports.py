...
class Reports(unittest.TestCase):
 ...
 def test_history_todo(self):
  ...
  todo=TODO.read_text();self.assertIn('Previous milestone closure evidence',todo);self.assertIn('Full suite: `1202/1202`.',todo);self.assertIn('GitHub Actions run `34608855632` tests/LaTeX passed.',todo)
