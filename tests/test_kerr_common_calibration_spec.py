...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  todo=T.read_text();self.assertIn('Kerr calibration-reference placement correction MVP',todo);self.assertIn('published auxiliary-channel milestone `16c9718`',todo)
