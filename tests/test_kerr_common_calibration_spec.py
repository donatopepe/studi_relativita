...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  todo=T.read_text();self.assertIn('Kerr shared-calibration robustness MVP',todo);self.assertIn('1. [ ] Ratify shared-calibration robustness specification. **ACTIVE**',todo)
