...
class Reports(unittest.TestCase):
 ...
 def test_history_todo(self):
  ...
  self.assertIn('4. [x] Generate stable artifacts and bilingual scientific record.',TODO.read_text());self.assertIn('5. [x] Closure and publication.',TODO.read_text());self.assertIn('Full suite: `1163/1163`.',TODO.read_text());self.assertIn('GitHub Actions run `34568400157` tests/LaTeX passed.',TODO.read_text())
