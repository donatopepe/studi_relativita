...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr critical lag-law radius MVP: tasks 1–5 completed',t);self.assertIn('scientific `8/8`, scenarios `142/142`, suite `1319/1319`',t)
