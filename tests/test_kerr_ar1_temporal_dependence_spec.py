...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr AR(1) temporal-dependence penalty MVP',t);self.assertIn('1. [x] Ratify AR(1) temporal-dependence specification.',t);self.assertIn('2. [x] Extend authoritative Kerr scenario matrix and runner.',t);self.assertIn('3. [x] Implement AR(1) covariance-penalty engine.',t);self.assertIn('4. [ ] Generate stable artifacts and bilingual scientific record. **ACTIVE**',t)
