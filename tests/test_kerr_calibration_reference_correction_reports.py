...
class Reports(unittest.TestCase):
 ...
 def test_history_todo(self):
  ...
  self.assertIn('4. [x] Correct bilingual scientific record and preserved history.',TODO.read_text());self.assertIn('5. [ ] Closure and publication. **ACTIVE — local gates green; push/CI pending**',TODO.read_text());self.assertIn('Full suite: `1176/1176`.',TODO.read_text())
