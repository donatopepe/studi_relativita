...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr composite common-calibration profile gate MVP',t);self.assertIn('1. [ ] Ratify composite-hypothesis profile specification. **ACTIVE**',t)
