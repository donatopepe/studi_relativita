...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr auxiliary calibration-channel identifiability MVP',t);self.assertIn('completed composite-profile milestone `431f90d`',t)
