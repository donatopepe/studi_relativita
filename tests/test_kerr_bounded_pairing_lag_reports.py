...
class Reports(unittest.TestCase):
 ...
 def test_history_and_todo(self):
  ...
  self.assertIn('Kerr bounded pairing-lag erosion MVP: tasks 1–5 completed',TODO.read_text());self.assertIn('scientific `8/8`, scenarios `110/110`, suite `1267/1267`',TODO.read_text());self.assertIn('Full suite: `1267/1267`.',TODO.read_text())
