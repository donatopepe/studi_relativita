...
class Reports(unittest.TestCase):
 ...
 def test_history_and_todo(self):
  ...
  self.assertIn('Kerr bounded latent-lag law robustness MVP: tasks 1–5 completed',TODO.read_text());self.assertIn('scientific `8/8`, scenarios `134/134`, suite `1306/1306`',TODO.read_text());self.assertIn('Full suite: `1306/1306`.',TODO.read_text())
