...
class Spec(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn('Metric:** `8/8`',p);self.assertIn('Kerr bounded latent-lag law robustness MVP: tasks 1–5 completed',t);self.assertIn('scientific `8/8`, scenarios `134/134`, suite `1306/1306`',t)
