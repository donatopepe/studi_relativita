...
- `Darwin1959GravityField`: reused for null trajectories and critical photon-orbit context only.
- `Sachs1961`: reused for null optical/Jacobi framework only.
- Ideal scalar coherent source, local oscillator, endpoint I/Q map, nuisance quotient and joined rank audit are project derivations or toy controls.
- These sources do not establish source coherence dynamics, emission/absorption interaction, polarization-screen coupling, receiver transfer, calibrated noise, joint covariance, `ell0`, UMCH, evidence or detection.
...
- Status: `VERIFIED_METADATA_AND_SCOPE`
- Canonical metadata: https://api.crossref.org/works/10.1119/1.2232644
- Canonical article: https://doi.org/10.1119/1.2232644
- Independent record: https://arxiv.org/abs/gr-qc/0601002
- Access date: 2026-08-21
- Exact supported topic: Serret–Frenet equations for timelike curves in Minkowski spacetime; relation of curve curvature/torsions to charged-particle motion in a constant uniform electromagnetic field.
- Limits: this source does not establish a universal positive lower curvature bound.

## PoissonPoundVega2011

- Status: `VERIFIED_METADATA_AND_SCOPE`
- Canonical metadata: https://api.crossref.org/works/10.12942/lrr-2011-7
- Canonical article: https://doi.org/10.12942/lrr-2011-7
- Independent record: https://arxiv.org/abs/1102.0529
- Access date: 2026-08-21
- Exact supported topic: authoritative review of point-particle motion and self-force for scalar, electromagnetic, and gravitational cases in curved spacetime.
- Limits: self-force-induced nongeodesic motion does not itself imply a universal `κ₀`.

## Will2014

- Status: `VERIFIED_METADATA_AND_SCOPE`
- Canonical metadata: https://api.crossref.org/works/10.12942/lrr-2014-4
- Canonical article: https://doi.org/10.12942/lrr-2014-4
- Independent record: https://arxiv.org/abs/1403.7377
- Access date: 2026-08-21
- Exact supported topic: review of experimental tests of general relativity, Einstein equivalence principle, local Lorentz invariance, clocks, and post-Newtonian gravity.
- Limits: later experimental updates will be required before deriving a current numerical bound.

## Galtsov2002

- Status: `VERIFIED_METADATA_AND_SCOPE`
- Canonical metadata: https://api.crossref.org/works/10.1103/PhysRevD.66.025016
- Canonical article: https://doi.org/10.1103/PhysRevD.66.025016
- Independent record: https://arxiv.org/abs/hep-th/0112110
- Access date: 2026-08-21
- Exact supported topic: dimensional dependence of classical radiation reaction and local/nonlocal effective equations.
- Limits: no UMCH regularization follows without deriving modified equations and checking their solutions.

## TiesingaEtAl2021

- Status: `VERIFIED_METADATA_AND_SCOPE`
- Canonical metadata: https://api.crossref.org/works/10.1103/RevModPhys.93.025010
- Canonical article: https://doi.org/10.1103/RevModPhys.93.025010
- Institutional record: https://www.nist.gov/publications/codata-recommended-values-fundamental-physical-constants-2018
- Access date: 2026-08-21
